        ...
        <ScrollView style={styles.scrollView}>
          ...
          <View style={styles.content}>
            ...
            <View style={styles.privacyOptions}>
              <Text style={styles.privacyHeading}>Riêng tư</Text>
              <TouchableHighlight
              ...
              >
                <View>
                  ...
                  <Text style={styles.privacyOptionDescription}>Mọi người đều có thể nhìn thấy ưa thích của bạn</Text>
              ...
              >
                <View>
                  ...
                  <Text style={styles.privacyOptionDescription}>Chỉ bạn và danh sách bạn bè có quyền xem chỉ mục này.</Text>
                  <View style={styles.privacyRadioInput}>
                    <RadioInput
                      backgroundColor={colors.gray07}
                      borderColor={colors.gray05}
